...
<template>
  <v-list-item :prepend-avatar="props.trackData.album.images[2].url" @click="handleClick" :disabled="props.disabled"
    ><span class="text-truncate text-caption px-2" :class="{ 'text-secondary': props.nowPlaying }">{{
